...
const bridge: PhotoCakeBridge = {
  ...
  loadLatestMomentQuickCull: (batchId) =>
    invoke<BackendMomentQuickCullOperation | null>("batch_latest_moment_quick_cull", {
      batchId,
    }),
  ...
  undoMomentQuickCull: (batchId, operationId) =>
    invoke<BackendMomentQuickCullOperation>("undo_moment_quick_cull", {
      batchId,
      operationId,
    }),
  ...
  confirmRecipeReviewGroups: (groupIds) =>
    invoke<BackendRecipeReviewGroupBatchResult>("confirm_recipe_review_groups", { groupIds }),
  ...
  writeBatchXmp: (groupIds) =>
    invoke<BackendLightroomBatchHandoffResult>("write_reference_xmp_batch", { groupIds }),
